...
[![Linux build status](https://travis-ci.org/GerHobbelt/clipp.svg?branch=master)](https://travis-ci.org/GerHobbelt/clipp) [![MSVC build status](https://ci.appveyor.com/api/projects/status/ci29ngpfks980i7g?svg=true)](https://ci.appveyor.com/project/GerHobbelt/clipp)
